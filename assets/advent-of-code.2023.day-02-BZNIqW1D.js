...
def test_runner(filename: str, total: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == total
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"70,265"})]}),e.jsx(r,{hash:"recap",children:"Recap"}),e.jsxs(o,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"2"}),e.jsx("td",{children:"00:15:33"}),e.jsx("td",{children:"3,061"}),e.jsx("td",{children:"00:21:22"}),e.jsx("td",{children:"3,179"})]})})]}),e.jsx("p",{children:"Much better than yesterday, my time was much better and I got the correct solution on my first submission for each part 😎."}),e.jsx("p",{children:"This was another super simple puzzle, the most time-consuming part was figuring out how to extract data from the string. My solution is fine, but I really hate the hardcoded color checks. But it works so ¯\\_(ツ)_/¯."}),e.jsx("p",{children:"May be worth doing some code cleanup and figure out some reusable utility functions. I'd really like to have a cleaner way to extract structured data from strings (and I don't really want to use regex 😒)."})]})};export{p as component};
