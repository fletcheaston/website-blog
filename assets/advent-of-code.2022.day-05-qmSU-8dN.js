import{r,j as o}from"./index-BOVISP07.js";import{s as P}from"./utils-D-kyB9IB.js";import{z as f,I as N}from"./view-input-CgTCnHyV.js";import{B as M}from"./button-BbjwN_Wg.js";import{P as s}from"./code-block-BHhHmU_4.js";import{B as D}from"./layout-CKZEFHhW.js";import{H as u}from"./header-00-8GVRa.js";import{S as Z}from"./separator-CAx1mVLs.js";import"./routeInfo-DNFRKWbG.js";const x={1:["Q","W","P","S","Z","R","H","D"],2:["V","B","R","W","Q","H","F"],3:["C","V","S","H"],4:["H","F","G"],5:["P","G","J","B","Z"],6:["Q","T","J","H","W","F","L"],7:["Z","T","W","D","L","V","J","N"],8:["D","T","Z","C","J","G","H","F"],9:["W","P","V","M","B","H"]},j=`move 1 from 3 to 9
move 2 from 2 to 1
move 3 from 5 to 4
move 1 from 1 to 8
move 1 from 3 to 9
...
move 14 from 7 to 1
move 4 from 6 to 5
move 1 from 1 to 9`,I=f.array(f.string().transform(m=>{var t;return(t=m.match(/\d+/g))==null?void 0:t.map(Number)}).pipe(f.tuple([f.number(),f.number(),f.number()])).transform(m=>({move:m[0],from:m[1],to:m[2]}))),C=I.parse(j.split(`
`));function T(){const[m,t]=r.useState("unstarted"),[g,a]=r.useState(0),[n,c]=r.useState(x),b=r.useMemo(()=>Object.fromEntries(Object.entries(n).map(([e,v])=>[e,v.join(" ")])),[n]),w=r.useMemo(()=>Object.values(n).map(e=>e[e.length-1]).join(""),[n]),k=r.useCallback(async()=>{t("in-progress"),c(x),a(0);for await(const e of C)a(v=>v+1),c(v=>{const i=structuredClone(v),l=i[e.from],d=i[e.to];if(!l)throw new Error(`Invalid from value: ${e.from}`);if(!d)throw new Error(`Invalid to value: ${e.to}`);for(let h=0;h<e.move;h++){const p=l.pop();if(!p)throw new Error("No value left in this stack");d.push(p)}return i}),await P(1);t("complete")},[t,c,a]);return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mt-4 flex gap-x-4",children:[o.jsx("div",{children:o.jsx(N,{input:j})}),o.jsx("div",{children:o.jsx(M,{size:"lg",onClick:k,disabled:m==="in-progress",children:"Process Input"})})]}),o.jsxs("div",{className:"mt-4 tabular-nums",children:[o.jsxs("div",{children:["Progress: ",g," / ",C.length]}),o.jsxs("div",{children:["State:",o.jsx("pre",{className:"mt-0",children:o.jsx("code",{className:"w-full",children:JSON.stringify(b,null,2)})})]}),o.jsxs("div",{children:["Top of state: ",o.jsx("code",{children:w})]})]})]})}const E=f.array(f.string().transform(m=>{var t;return(t=m.match(/\d+/g))==null?void 0:t.map(Number)}).pipe(f.tuple([f.number(),f.number(),f.number()])).transform(m=>({move:m[0],from:m[1],to:m[2]}))),S=E.parse(j.split(`
`));function F(){const[m,t]=r.useState("unstarted"),[g,a]=r.useState(0),[n,c]=r.useState(x),b=r.useMemo(()=>Object.fromEntries(Object.entries(n).map(([e,v])=>[e,v.join(" ")])),[n]),w=r.useMemo(()=>Object.values(n).map(e=>e[e.length-1]).join(""),[n]),k=r.useCallback(async()=>{t("in-progress"),c(x),a(0);for await(const e of S)a(v=>v+1),c(v=>{const i=structuredClone(v),l=i[e.from],d=i[e.to];if(!l)throw new Error(`Invalid from value: ${e.from}`);if(!d)throw new Error(`Invalid to value: ${e.to}`);const h=[];for(let p=0;p<e.move;p++){const y=l.pop();if(!y)throw new Error("No value left in this stack");h.push(y)}return d.push(...h.toReversed()),i}),await P(1);t("complete")},[t,c,a]);return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mt-4 flex gap-x-4",children:[o.jsx("div",{children:o.jsx(N,{input:j})}),o.jsx("div",{children:o.jsx(M,{size:"lg",onClick:k,disabled:m==="in-progress",children:"Process Input"})})]}),o.jsxs("div",{className:"mt-4 tabular-nums",children:[o.jsxs("div",{children:["Progress: ",g," / ",S.length]}),o.jsxs("div",{children:["State:",o.jsx("pre",{className:"mt-0",children:o.jsx("code",{className:"w-full",children:JSON.stringify(b,null,2)})})]}),o.jsxs("div",{children:["Top of state: ",o.jsx("code",{children:w})]})]})]})}const R=function(){return o.jsxs(o.Fragment,{children:[o.jsx(D,{}),o.jsx(u,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),o.jsxs("p",{children:["The expedition can depart as soon as the final supplies have been unloaded from the ships. Supplies are stored in stacks of marked ",o.jsx("em",{children:"crates"}),", but because the needed supplies are buried under many other crates, the crates need to be rearranged."]}),o.jsxs("p",{children:["The ship has a ",o.jsx("em",{children:"giant cargo crane"})," capable of moving crates between stacks. To ensure none of the crates get crushed or fall over, the crane operator will rearrange them in a series of carefully-planned steps. After the crates are rearranged, the desired crates will be at the top of each stack."]}),o.jsxs("p",{children:["The Elves don't want to interrupt the crane operator during this delicate procedure, but they forgot to ask her ",o.jsx("em",{children:"which"})," crate will end up where, and they want to be ready to unload them as soon as possible so they can embark."]}),o.jsxs("p",{children:["They do, however, have a drawing of the starting stacks of crates ",o.jsx("em",{children:"and"})," the rearrangement procedure (your puzzle input). For example:"]}),o.jsx(s,{content:`    [D]    
[N] [C]    
[Z] [M] [P]
 1   2   3 
...
[C]     [P]
 1   2   3`}),o.jsx("p",{children:"Finally, one crate is moved from stack 1 to stack 2:"}),o.jsx(s,{content:`        [Z]
        ...
        [D]
[C] [M] [P]
 1   2   3`}),o.jsxs("p",{children:["The Elves just need to know ",o.jsx("em",{children:"which crate will end up on top of each stack"}),"; in this example, the top crates are ",o.jsx("code",{children:"C"})," in stack 1, ",o.jsx("code",{children:"M"})," in stack 2, and ",o.jsx("code",{children:"Z"})," in stack 3, so you should combine these together and give the Elves the message"," ",o.jsx("code",{children:o.jsx("em",{children:"CMZ"})}),"."]}),o.jsx("p",{children:o.jsx("em",{children:"After the rearrangement procedure completes, what crate ends up on top of each stack?"})}),o.jsx(u,{hash:"part-1-solution",children:"Part 1 – Solution"}),o.jsx(T,{}),o.jsx(Z,{}),o.jsx(u,{hash:"part-2-prompt",children:"Part 2 – Prompt"}),o.jsx("p",{children:"As you watch the crane operator expertly rearrange the crates, you notice the process isn't following your prediction."}),o.jsxs("p",{children:["Some mud was covering the writing on the side of the crane, and you quickly wipe it away. The crane isn't a CrateMover 9000 - it's a"," ",o.jsx("em",{children:o.jsx("span",{title:"It's way better than the old CrateMover 1006.",children:"CrateMover 9001"})}),"."]}),o.jsxs("p",{children:["The CrateMover 9001 is notable for many new and exciting features: air conditioning, leather seats, an extra cup holder, and"," ",o.jsx("em",{children:"the ability to pick up and move multiple crates at once"}),"."]}),o.jsx("p",{children:"Again considering the example above, the crates begin in the same configuration:"}),o.jsx(s,{content:`    [D]    
[N] [C]    
[Z] [M] [P]
