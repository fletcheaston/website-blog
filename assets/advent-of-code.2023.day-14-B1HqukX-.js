...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"90,551"})]}),e.jsx(o,{}),e.jsx(r,{hash:"recap",children:"Recap"}),e.jsxs(l,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"14"}),e.jsx("td",{children:"02:04:22"}),e.jsx("td",{children:"9,332"}),e.jsx("td",{children:"03:18:55"}),e.jsx("td",{children:"6,846"})]})})]}),e.jsx("p",{children:"I started ~1 hour 34 minutes late 🙃."}),e.jsx("p",{children:"I ended up making some tests for the rotate functions, that took a bit of fiddling to get correct. And the end result is still very strange looking. I perform a 90 degree roatation, then three 270 degree rotations, then a final 180 degree rotation to complete a cycle. It works, just very strange looking."}),e.jsx("p",{children:"Detecting cycles wasn't particularly hard, I could just convert the board to a string and check against a dict/set of strings. I used a dictionary, mapping string-boards to steps, which made some of the math easier."}),e.jsx("p",{children:"Once we find our cycle, we just account for the cycle start offset and we can find the final board configuration with a simple lookup table."})]})};export{_ as component};
