...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"30,442"})]}),e.jsx(s,{}),e.jsx(n,{hash:"recap",children:"Recap"}),e.jsxs(a,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"13"}),e.jsx("td",{children:"00:23:19"}),e.jsx("td",{children:"1,460"}),e.jsx("td",{children:"00:48:58"}),e.jsx("td",{children:"2,122"})]})})]})]})};export{x as component};
