...
After 6 blinks:
2097446912 14168 4048 2 0 2 4 40 48 2024 40 48 80 96 2 8 6 7 6 0 3 2`}),e.jsxs("p",{children:["In this example, after blinking six times, you would have ",e.jsx("code",{children:"22"})," stones. After blinking 25 times, you would have"," ",e.jsx("code",{children:e.jsx("em",{children:"55312"})})," ","stones!"]}),e.jsxs("p",{children:["Consider the arrangement of stones in front of you."," ",e.jsx("em",{children:"How many stones will you have after blinking 25 times?"})]}),e.jsx(u,{hash:"part-1-solution",children:"Part 1 – Solution"}),e.jsx(F,{}),e.jsx("p",{className:"mt-4",children:'Brute-force solution. Keep track of all stones in a single array, recalculating the entire array for every "blink".'}),e.jsx(g,{content:`const allStones = allStones.map((stone) => {
    if (stone === 0) {
        return [1];
    }
...
`}),e.jsx(b,{}),e.jsx(u,{hash:"part-2-prompt",children:"Part 2 – Prompt"}),e.jsxs("p",{children:["The Historians sure are taking a long time. To be fair, the infinite corridors"," ",e.jsx("em",{children:"are"})," very large."]}),e.jsx("p",{children:e.jsx("em",{children:"How many stones would you have after blinking a total of 75 times?"})}),e.jsx(u,{hash:"part-2-solution",children:"Part 2 – Solution"}),e.jsx(D,{}),e.jsx("p",{className:"mt-4",children:"Part 2 uses a completely different algorithm than Part 1. Keep track of stone counts instead of individual stones."}),e.jsx(g,{content:`const stoneCounter = Object.entries(stoneCounter).reduce(
