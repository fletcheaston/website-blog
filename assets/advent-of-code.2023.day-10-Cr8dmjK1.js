...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"413"})]}),e.jsx(o,{}),e.jsx(n,{hash:"recap",children:"Recap"}),e.jsxs(a,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"10"}),e.jsx("td",{children:"01:13:29"}),e.jsx("td",{children:"5,227"}),e.jsx("td",{children:"02:53:15"}),e.jsx("td",{children:"3,953"})]})})]}),e.jsx(n,{hash:"visualizations",children:"Visualizations"}),e.jsx("p",{children:"Red rectangles represent the enclosed characters within the map."}),e.jsxs("p",{children:["Green rectangles represent the characters within the map that"," ",e.jsx("strong",{children:"appear"})," to be enclosed but actually ",e.jsx("strong",{children:"aren't"}),"."]}),e.jsx("h3",{children:"Large - Enclosed"}),e.jsx(i,{src:"/blog/advent-of-code/2023/day-10/pipe-maze-large-empty.png",alt:"Pipe Maze Empty"}),e.jsx("h3",{children:"Large - Enclosed + Escaped"}),e.jsx(i,{src:"/blog/advent-of-code/2023/day-10/pipe-maze-large-filled.png",alt:"Pipe Maze Filled"})]})};export{u as component};
