import{j as e,b3 as i}from"./main-6CusI5Kr.js";import{P as t,a as s}from"./code-block-DJuaFDsd.js";import{B as l}from"./layout-DPQIvm_h.js";import{H as a}from"./header-B42DZ3GE.js";import{T as r}from"./table-BieFWCaC.js";import{S as n}from"./separator-S9MOKPTH.js";import"./button-DBE4koem.js";const u=function(){return e.jsxs(e.Fragment,{children:[e.jsx(l,{to:i.fullPath}),e.jsx(a,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsx("p",{children:'You continue following signs for "Hot Springs" and eventually come across an observatory. The Elf within turns out to be a researcher studying cosmic expansion using the giant telescope here.'}),e.jsx("p",{children:"He doesn't know anything about the missing machine parts; he's only visiting for this research project. However, he confirms that the hot springs are the next-closest area likely to have people; he'll even take you straight there once he's done with today's observation analysis."}),e.jsx("p",{children:"Maybe you can help him with the analysis to speed things up?"}),e.jsxs("p",{children:["The researcher has collected a bunch of data and compiled the data into a single giant ",e.jsx("strong",{children:"image"})," (your puzzle input). The image includes"," ",e.jsx("strong",{children:"empty space"})," (",e.jsx("code",{children:"."}),") and ",e.jsx("strong",{children:"galaxies"})," (",e.jsx("code",{children:"#"}),"). For example:"]}),e.jsx(t,{content:`...#......
.......#..
#.........
..........
......#...
