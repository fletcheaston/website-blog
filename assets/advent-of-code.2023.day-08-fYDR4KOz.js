...
def test_runner(filename: str, instructions: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"22,289,513,667,691"})]}),e.jsx(r,{}),e.jsx(t,{hash:"recap",children:"Recap"}),e.jsxs(i,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"8"}),e.jsx("td",{children:"00:09:41"}),e.jsx("td",{children:"2,164"}),e.jsx("td",{children:"02:16:39"}),e.jsx("td",{children:"9,554"})]})})]}),e.jsx("p",{children:"Part 1 was very easy and the kind of problem I really enjoy!"}),e.jsx("p",{children:"I first tried the brute-force solution on Part 2. Once it didn't complete within 30 seconds, I knew I'd need to implement cycle counting to get a reasonably-fast answer, but I left the script running anyway just in case it happened to complete eventually. That script didn't complete with >2 hours of runtime 😬."}),e.jsxs("p",{children:["Cycle counting was simple ",e.jsx("em",{children:"in theory"}),", but ",e.jsx("em",{children:"in practice"}),", I had a lot of trouble figuring out how to do it properly. I did use custom test cases like I did in Day 7, but even then, it took a really long time to figure out a correct implementation 😖."]})]})};export{x as component};
