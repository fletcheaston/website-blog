var z=Object.defineProperty;var N=(r,t,p)=>t in r?z(r,t,{enumerable:!0,configurable:!0,writable:!0,value:p}):r[t]=p;var l=(r,t,p)=>N(r,typeof t!="symbol"?t+"":t,p);import{r as u,j as e,d as D}from"./index-pVkOv_V0.js";import{s as m}from"./utils-D-kyB9IB.js";import{I as S,z as h}from"./view-input-CR9UPHSm.js";import{s as E}from"./colors-CC0NICH4.js";import{B as R}from"./button-B5HZ_MqN.js";import{P as f,T as j}from"./code-block-BfbB0D4o.js";import{B as M}from"./layout-BXICE6-W.js";import{H as y}from"./header-CdWFbH8W.js";import{T as A}from"./table-DLxfe7i9.js";import{S as T}from"./separator-PTGZMsnp.js";import"./__vite-browser-external-D7Ct-6yo.js";import"./routeInfo-Bq4EKpvI.js";const i=101,n=103,w=`p=43,30 v=73,-79
p=20,21 v=-72,96
p=24,57 v=-95,97
p=29,86 v=-19,83
p=30,80 v=-91,-16
...
p=88,67 v=54,-14
p=35,98 v=29,-22
p=19,9 v=-44,-18`,$=h.array(h.string().transform(r=>{const t=r.replace("p=","").replace(" v=",",").split(",");return{px:t[0],py:t[1],vx:t[2],vy:t[3]}}).pipe(h.object({px:h.coerce.number(),py:h.coerce.number(),vx:h.coerce.number(),vy:h.coerce.number()}))),W=$.parse(w.split(`
`)),G=100,g=400,q=400;let _=class{constructor(t){l(this,"px");l(this,"py");l(this,"vx");l(this,"vy");l(this,"color");this.px=t.px,this.py=t.py,this.vx=t.vx,this.vy=t.vy,this.color=E(JSON.stringify(t))}step(){for(this.px+=this.vx,this.py+=this.vy;this.px<0;)this.px=i+this.px;for(;this.px>=i;)this.px=this.px-i;for(;this.py<0;)this.py=n+this.py;for(;this.py>=n;)this.py=this.py-n}quadrant(){const t=this.px>=0&&this.px<Math.floor(i/2),p=this.px>=Math.ceil(i/2)&&this.px<=i,s=this.py>=0&&this.py<Math.floor(n/2),o=this.py>=Math.ceil(n/2)&&this.py<=n;return t&&s?"q1":p&&s?"q2":p&&o?"q3":t&&o?"q4":null}},H=class{constructor(){l(this,"robots");this.robots=W.map(t=>new _(t))}step(){this.robots.forEach(t=>t.step())}safetyFactor(){const t={q1:0,q2:0,q3:0,q4:0};return this.robots.forEach(p=>{const s=p.quadrant();s&&(t[s]+=1)}),t.q1*t.q2*t.q3*t.q4}rows(){const t=[];for(let p=0;p<n;p+=1){let s="";for(let o=0;o<i;o+=1){const a=this.robots.filter(v=>v.px===o&&v.py===p);a.length>0?s=`${s}${a.length}`:s=`${s} `}t.push(s)}return t}};function F(){const[r,t]=u.useState("unstarted"),[p,s]=u.useState(0),o=u.useRef();o.current||(o.current=new H);const a=u.useCallback(async()=>{t("in-progress"),s(0);const v=new H;o.current=v;for(let x=0;x<G;x+=1)s(d=>d+1),v.step(),await m(500);t("complete")},[t,s]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mt-4 flex gap-x-4",children:[e.jsx("div",{children:e.jsx(S,{input:w})}),e.jsx("div",{children:e.jsx(R,{size:"lg",onClick:a,disabled:r==="in-progress",children:"Process Input"})})]}),e.jsxs("div",{className:"mt-4 tabular-nums",children:[e.jsxs("div",{children:["Iterations: ",p]}),e.jsxs("div",{children:["Safety Factor: ",e.jsx("code",{children:o.current.safetyFactor()})]}),e.jsx("pre",{className:"mt-0",children:e.jsx("code",{className:"relative",style:{height:q,width:g},children:o.current.robots.map((v,x)=>e.jsx("div",{className:"absolute transition-all duration-500 ease-linear",style:{top:v.py/n*q,left:v.px/i*g,height:q/n,width:g/i,backgroundColor:v.color}},x))})})]})]})}const B=h.array(h.string().transform(r=>{const t=r.replace("p=","").replace(" v=",",").split(",");return{px:t[0],py:t[1],vx:t[2],vy:t[3]}}).pipe(h.object({px:h.coerce.number(),py:h.coerce.number(),vx:h.coerce.number(),vy:h.coerce.number()}))),Y=B.parse(w.split(`
`)),I=400,P=400;class L{constructor(t){l(this,"px");l(this,"py");l(this,"vx");l(this,"vy");l(this,"color");this.px=t.px,this.py=t.py,this.vx=t.vx,this.vy=t.vy,this.color=E(JSON.stringify(t))}step(){for(this.px+=this.vx,this.py+=this.vy;this.px<0;)this.px=i+this.px;for(;this.px>=i;)this.px=this.px-i;for(;this.py<0;)this.py=n+this.py;for(;this.py>=n;)this.py=this.py-n}}class k{constructor(){l(this,"robots");this.robots=Y.map(t=>new L(t))}step(){this.robots.forEach(t=>t.step())}robotPositionsAreUnique(){const t=new Set;for(const p of this.robots){const s=`${p.py},${p.px}`;if(t.has(s))return!1;t.add(s)}return!0}rows(){const t=[];for(let p=0;p<n;p+=1){let s="";for(let o=0;o<i;o+=1){const a=this.robots.filter(v=>v.px===o&&v.py===p);a.length>0?s=`${s}${a.length}`:s=`${s} `}t.push(s)}return t}}const b={off:0,fast:100,moderate:200,slow:500,"super-slow":1e3};function Q(){const[r,t]=u.useState("unstarted"),[p,s]=u.useState(0),[o,a]=u.useState("off"),v=u.useRef();v.current||(v.current=new k);const x=u.useCallback(async()=>{t("in-progress"),s(0),a("off");const d=new k;v.current=d;let c=0;for(;!d.robotPositionsAreUnique();)s(C=>C+1),c+=1,d.step(),c%13===0&&await m(1),c>6863&&c<=6873?(a("fast"),await m(b.fast)):c>6873&&c<=6878?(a("moderate"),await m(b.moderate)):c>6878&&c<=6883?(a("slow"),await m(b.slow)):c>6883&&(a("super-slow"),await m(b["super-slow"]));t("complete")},[t,s,a]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mt-4 flex items-center gap-x-4",children:[e.jsx("div",{children:e.jsx(S,{input:w})}),e.jsx("div",{children:e.jsx(R,{size:"lg",onClick:x,disabled:r==="in-progress",children:"Process Input"})})]}),e.jsxs("div",{className:"mt-4",children:[e.jsx("div",{className:"text-rose-800",children:"WARNING"}),e.jsxs("div",{children:["This takes a several seconds to process. My answer was ",e.jsx("code",{children:"6888"}),", so it'll take that many iterations until the result is displayed. I've hard-coded the animation timing to look good for my input."]})]}),e.jsxs("div",{className:"mt-4 tabular-nums",children:[e.jsxs("div",{children:["Iterations: ",p]}),e.jsx("pre",{className:"mt-0",children:e.jsx("code",{className:"relative",style:{height:P,width:I},children:v.current.robots.map((d,c)=>e.jsx("div",{className:D("absolute",o!=="off"?"transition-all ease-linear":""),style:{top:d.py/n*P,left:d.px/i*I,height:P/n,width:I/i,backgroundColor:d.color,transitionDuration:`${b[o]}ms`}},c))})})]})]})}const ne=function(){return e.jsxs(e.Fragment,{children:[e.jsx(M,{}),e.jsx(y,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsx("p",{children:"One of The Historians needs to use the bathroom; fortunately, you know there's a bathroom near an unvisited location on their list, and so you're all quickly teleported directly to the lobby of Easter Bunny Headquarters."}),e.jsxs("p",{children:['Unfortunately, EBHQ seems to have "improved" bathroom security ',e.jsx("em",{children:"again"})," after your last"," ",e.jsx("a",{href:"https://adventofcode.com/2016/day/2",target:"_blank",children:"visit"}),". The area outside the bathroom is swarming with robots!"]}),e.jsxs("p",{children:["To get The Historian safely to the bathroom, you'll need a way to predict where the robots will be in the future. Fortunately, they all seem to be moving on the tile floor in predictable ",e.jsx("em",{children:"straight lines"}),"."]}),e.jsxs("p",{children:["You make a list (your puzzle input) of all of the robots' current ",e.jsx("em",{children:"positions"})," ","(",e.jsx("code",{children:"p"}),") and ",e.jsx("em",{children:"velocities"})," (",e.jsx("code",{children:"v"}),"), one robot per line. For example:"]}),e.jsx(f,{content:`p=0,4 v=3,-3
p=6,3 v=-1,-3
p=10,3 v=-1,2
p=2,0 v=2,-1
p=0,0 v=1,3
