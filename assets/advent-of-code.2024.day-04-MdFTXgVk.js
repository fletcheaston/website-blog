import{r as l,j as M}from"./index-pVkOv_V0.js";import{s as v}from"./utils-D-kyB9IB.js";import{I as w,z as d}from"./view-input-CR9UPHSm.js";import{B as g}from"./button-B5HZ_MqN.js";import{P as h,T as f}from"./code-block-BfbB0D4o.js";import{B as y}from"./layout-BXICE6-W.js";import{H as u}from"./header-CdWFbH8W.js";import{T as b}from"./table-DLxfe7i9.js";import{S as j}from"./separator-PTGZMsnp.js";import"./routeInfo-Bq4EKpvI.js";const p=`XMXMAXXSXSSMMMXAMXMMMAMXMAMXAMSAMXSAMXMXMMMAXXMASMSMSAMXMSMMMAMXMXAMMAMMMXMAMMMMMAMMMMSAMXMMAMXAXMXMAMXSXSMMSMMMMSMMXXAMSMSASAXMMMSMMMSMASMM
...
SXXAMMAXMAMMXMXMASASMSASMSXSAMAMXAMSAMXSSMASMSMMMXSAMXSSMMAXSXSASXMSAMXXMMMAMXXMXXSAMXMMMXXMASMMSMMMMSAMXSMAXMASXSMSSSMXXAMMXASMXAMXSASXSSMS`,k=d.array(d.string().transform(A=>A.split(""))),n=k.parse(p.split(`
`)),x=[];n.forEach((A,S)=>{A.forEach((t,e)=>{x.push([S,e])})});function P(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A+1])==null?void 0:e[S])==="M"&&((s=n[A+2])==null?void 0:s[S])==="A"&&((X=n[A+3])==null?void 0:X[S])==="S"}function R(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A-1])==null?void 0:e[S])==="M"&&((s=n[A-2])==null?void 0:s[S])==="A"&&((X=n[A-3])==null?void 0:X[S])==="S"}function D(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A])==null?void 0:e[S+1])==="M"&&((s=n[A])==null?void 0:s[S+2])==="A"&&((X=n[A])==null?void 0:X[S+3])==="S"}function L(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A])==null?void 0:e[S-1])==="M"&&((s=n[A])==null?void 0:s[S-2])==="A"&&((X=n[A])==null?void 0:X[S-3])==="S"}function z(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A+1])==null?void 0:e[S+1])==="M"&&((s=n[A+2])==null?void 0:s[S+2])==="A"&&((X=n[A+3])==null?void 0:X[S+3])==="S"}function U(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A-1])==null?void 0:e[S+1])==="M"&&((s=n[A-2])==null?void 0:s[S+2])==="A"&&((X=n[A-3])==null?void 0:X[S+3])==="S"}function I(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A-1])==null?void 0:e[S-1])==="M"&&((s=n[A-2])==null?void 0:s[S-2])==="A"&&((X=n[A-3])==null?void 0:X[S-3])==="S"}function T(A,S){var t,e,s,X;return((t=n[A])==null?void 0:t[S])==="X"&&((e=n[A+1])==null?void 0:e[S-1])==="M"&&((s=n[A+2])==null?void 0:s[S-2])==="A"&&((X=n[A+3])==null?void 0:X[S-3])==="S"}function E(){const[A,S]=l.useState("unstarted"),[t,e]=l.useState(0),[s,X]=l.useState(0),i=l.useCallback(async()=>{S("in-progress"),X(0),e(0);for await(const[o,c]of x)e(r=>r+1),P(o,c)&&X(r=>r+1),R(o,c)&&X(r=>r+1),D(o,c)&&X(r=>r+1),L(o,c)&&X(r=>r+1),z(o,c)&&X(r=>r+1),U(o,c)&&X(r=>r+1),T(o,c)&&X(r=>r+1),I(o,c)&&X(r=>r+1),await v(1);S("complete")},[S,X,e]);return M.jsxs(M.Fragment,{children:[M.jsxs("div",{className:"mt-4 flex gap-x-4",children:[M.jsx("div",{children:M.jsx(w,{input:p})}),M.jsx("div",{children:M.jsx(g,{size:"lg",onClick:i,disabled:A==="in-progress",children:"Process Input"})})]}),M.jsxs("div",{className:"mt-4 tabular-nums",children:[M.jsxs("div",{children:["Progress: ",t," / ",x.length]}),M.jsxs("div",{children:["State: ",s]})]})]})}const C=d.array(d.string().transform(A=>A.split(""))),a=C.parse(p.split(`
`)),m=[];a.forEach((A,S)=>{A.forEach((t,e)=>{m.push([S,e])})});function H(A,S){var t,e,s,X,i;return((t=a[A])==null?void 0:t[S])==="A"&&((e=a[A-1])==null?void 0:e[S-1])==="M"&&((s=a[A+1])==null?void 0:s[S-1])==="S"&&((X=a[A-1])==null?void 0:X[S+1])==="M"&&((i=a[A+1])==null?void 0:i[S+1])==="S"}function $(A,S){var t,e,s,X,i;return((t=a[A])==null?void 0:t[S])==="A"&&((e=a[A-1])==null?void 0:e[S-1])==="S"&&((s=a[A+1])==null?void 0:s[S-1])==="M"&&((X=a[A-1])==null?void 0:X[S+1])==="S"&&((i=a[A+1])==null?void 0:i[S+1])==="M"}function B(A,S){var t,e,s,X,i;return((t=a[A])==null?void 0:t[S])==="A"&&((e=a[A-1])==null?void 0:e[S-1])==="M"&&((s=a[A+1])==null?void 0:s[S-1])==="M"&&((X=a[A-1])==null?void 0:X[S+1])==="S"&&((i=a[A+1])==null?void 0:i[S+1])==="S"}function F(A,S){var t,e,s,X,i;return((t=a[A])==null?void 0:t[S])==="A"&&((e=a[A-1])==null?void 0:e[S-1])==="S"&&((s=a[A+1])==null?void 0:s[S-1])==="S"&&((X=a[A-1])==null?void 0:X[S+1])==="M"&&((i=a[A+1])==null?void 0:i[S+1])==="M"}function N(){const[A,S]=l.useState("unstarted"),[t,e]=l.useState(0),[s,X]=l.useState(0),i=l.useCallback(async()=>{S("in-progress"),X(0),e(0);for await(const[o,c]of m)e(r=>r+1),H(o,c)&&X(r=>r+1),$(o,c)&&X(r=>r+1),B(o,c)&&X(r=>r+1),F(o,c)&&X(r=>r+1),await v(1);S("complete")},[S,X,e]);return M.jsxs(M.Fragment,{children:[M.jsxs("div",{className:"mt-4 flex gap-x-4",children:[M.jsx("div",{children:M.jsx(w,{input:p})}),M.jsx("div",{children:M.jsx(g,{size:"lg",onClick:i,disabled:A==="in-progress",children:"Process Input"})})]}),M.jsxs("div",{className:"mt-4 tabular-nums",children:[M.jsxs("div",{children:["Progress: ",t," / ",m.length]}),M.jsxs("div",{children:["State: ",s]})]})]})}const Z=function(){return M.jsxs(M.Fragment,{children:[M.jsx(y,{}),M.jsx(u,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),M.jsxs("p",{children:[`"Looks like the Chief's not here. Next!" One of The Historians pulls out a device and pushes the only button on it. After a brief flash, you recognize the interior of the`," ",M.jsx("a",{href:"https://adventofcode.com/2019/day/10",target:"_blank",children:"Ceres monitoring station"}),"!"]}),M.jsxs("p",{children:["As the search for the Chief continues, a small Elf who lives on the station tugs on your shirt; she'd like to know if you could help her with her ",M.jsx("em",{children:"word search"})," ","(your puzzle input). She only has to find one word: ",M.jsx("code",{children:"XMAS"}),"."]}),M.jsxs("p",{children:["This word search allows words to be horizontal, vertical, diagonal, written backwards, or even overlapping other words. It's a little unusual, though, as you don't merely need to find one instance of ",M.jsx("code",{children:"XMAS"})," - you need to find"," ",M.jsx("em",{children:"all of them"}),". Here are a few ways ",M.jsx("code",{children:"XMAS"})," might appear, where irrelevant characters have been replaced with ",M.jsx("code",{children:"."}),":"]}),M.jsx(h,{content:`..X...
.SAMX.
.A..A.
XMAS.S
...
`}),M.jsx(j,{}),M.jsx(u,{hash:"recap",children:"Recap"}),M.jsxs(b,{children:[M.jsx("thead",{children:M.jsxs("tr",{children:[M.jsx("th",{children:"Part 1 Time"}),M.jsx("th",{children:"Part 1 Rank"}),M.jsx("th",{children:"Part 2 Time"}),M.jsx("th",{children:"Part 2 Rank"})]})}),M.jsx("tbody",{children:M.jsxs("tr",{children:[M.jsx("td",{children:"00:16:41"}),M.jsx("td",{children:"3,254"}),M.jsx("td",{children:"00:20:01"}),M.jsx("td",{children:"1,717"})]})})]}),M.jsx("p",{children:"I considered two options for this:"}),M.jsxs("ol",{children:[M.jsx("li",{children:"Create new strings that were forwards, backwards, up, down, and diagonals, then do simple searches across those strings for matching text"}),M.jsx("li",{children:"Iterate over coordinates within the string matrix and check surrounding coordinates"})]}),M.jsx("p",{children:"After a few minutes of trying the first idea, I gave up and went for the second one, which was very straightforward to implement. Should've just done that from the start, but oh well."})]})};export{Z as component};
