...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"50,338,344,809,230"})]}),e.jsx(s,{}),e.jsx(n,{hash:"recap",children:"Recap"}),e.jsxs(a,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"12"}),e.jsx("td",{children:"03:02:15"}),e.jsx("td",{children:"8,882"}),e.jsx("td",{children:"03:16:49"}),e.jsx("td",{children:"3,382"})]})})]}),e.jsx("p",{children:"Finding an efficient recursive function was extremely challenging 😖."}),e.jsx("p",{children:"I had a solution much earlier that worked for the example input, but that solution was extremely slow for the real input (taking ~2 hours 45 minutes to complete [I started it and left the terminal window open while I worked on the more efficient solution above])."})]})};export{f as component};
