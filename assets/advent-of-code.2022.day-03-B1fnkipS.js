import{r as l,j as t}from"./index-BOVISP07.js";import{s as B}from"./utils-D-kyB9IB.js";import{z as h,I as L}from"./view-input-CgTCnHyV.js";import{B as H}from"./button-BbjwN_Wg.js";import{P as T,T as b}from"./code-block-BHhHmU_4.js";import{B as J}from"./layout-CKZEFHhW.js";import{H as f}from"./header-00-8GVRa.js";import{S as G}from"./separator-CAx1mVLs.js";import"./routeInfo-DNFRKWbG.js";const j=`jLnFTjhwFTLFDGDDvLgvDssBJBbVRNZJPPJBGzBNRVJNRB
...
rhPrSgfvJPfmwsTpLcsV`,M=h.array(h.string()),N=M.parse(j.split(`
`)),Z="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",W=Object.fromEntries(Z.split("").map((e,s)=>[e,s+1]));function D(){const[e,s]=l.useState("unstarted"),[r,n]=l.useState(0),[a,d]=l.useState(0),g=l.useCallback(async()=>{s("in-progress"),d(0),n(0);let i=0;for await(const c of N){n(o=>o+1);const v=new Set(c.slice(0,c.length/2)),w=new Set(c.slice(c.length/2,c.length)),m=v.intersection(w).values().next();if(!m.value)throw new Error("No duplicate for this row.");const p=W[m.value];if(!p)throw new Error(`No points assigned for this character: ${m.value}`);i+=p,d(i),await B(1)}s("complete")},[s,d,n]);return t.jsxs("div",{className:"mt-4 flex gap-x-4",children:[t.jsx("div",{children:t.jsx(L,{input:j})}),t.jsx("div",{children:t.jsx(H,{size:"lg",onClick:g,disabled:e==="in-progress",children:"Process Input"})}),t.jsxs("div",{className:"tabular-nums",children:[t.jsxs("div",{children:["Progress: ",r," / ",N.length]}),t.jsxs("div",{children:["Total Score: ",t.jsx("code",{children:a})]})]})]})}const F=h.array(h.string()).transform(e=>{if(e.length%3!==0)throw new Error("Number of values needs to be divisible by three.");const s=[];let r=[];return e.forEach(n=>{r.length===3&&(s.push([...r]),r=[]),r.push(n)}),s.push([...r]),s}).pipe(h.array(h.tuple([h.string(),h.string(),h.string()]))),P=F.parse(j.split(`
`)),R="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",q=Object.fromEntries(R.split("").map((e,s)=>[e,s+1]));function z(){const[e,s]=l.useState("unstarted"),[r,n]=l.useState(0),[a,d]=l.useState(0),g=l.useCallback(async()=>{s("in-progress"),d(0),n(0);let i=0;for await(const c of P){n(S=>S+1);const v=new Set(c[0]),w=new Set(c[1]),m=new Set(c[2]),p=v.intersection(w).intersection(m).values().next();if(!p.value)throw new Error("No duplicate for this row.");const o=q[p.value];if(!o)throw new Error(`No points assigned for this character: ${p.value}`);i+=o,d(i),await B(1)}s("complete")},[s,d,n]);return t.jsxs("div",{className:"mt-4 flex gap-x-4",children:[t.jsx("div",{children:t.jsx(L,{input:j})}),t.jsx("div",{children:t.jsx(H,{size:"lg",onClick:g,disabled:e==="in-progress",children:"Process Input"})}),t.jsxs("div",{className:"tabular-nums",children:[t.jsxs("div",{children:["Progress: ",r," / ",P.length]}),t.jsxs("div",{children:["Total Score: ",t.jsx("code",{children:a})]})]})]})}const A=function(){return t.jsxs(t.Fragment,{children:[t.jsx(J,{}),t.jsx(f,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),t.jsxs("p",{children:["One Elf has the important job of loading all of the"," ",t.jsx("a",{href:"https://en.wikipedia.org/wiki/Rucksack",target:"_blank",children:"rucksacks"})," ","with supplies for the"," ",t.jsx("span",{title:"Where there's jungle, there's hijinxs.",children:"jungle"})," journey. Unfortunately, that Elf didn't quite follow the packing instructions, and so a few items now need to be rearranged."]}),t.jsxs("p",{children:["Each rucksack has two large ",t.jsx("em",{children:"compartments"}),". All items of a given type are meant to go into exactly one of the two compartments. The Elf that did the packing failed to follow this rule for exactly one item type per rucksack."]}),t.jsxs("p",{children:["The Elves have made a list of all of the items currently in each rucksack (your puzzle input), but they need your help finding the errors. Every item type is identified by a single lowercase or uppercase letter (that is, ",t.jsx("code",{children:"a"})," and"," ",t.jsx("code",{children:"A"})," refer to different types of items)."]}),t.jsx("p",{children:"The list of items for each rucksack is given as characters all on a single line. A given rucksack always has the same number of items in each of its two compartments, so the first half of the characters represent items in the first compartment, while the second half of the characters represent items in the second compartment."}),t.jsx("p",{children:"For example, suppose you have the following list of contents from six rucksacks:"}),t.jsx(T,{content:`vJrwpWtwJgWrhcsFMMfFFhFp
...
);`}),t.jsx(D,{}),t.jsx(G,{}),t.jsx(f,{hash:"part-2-prompt",children:"Part 2 – Prompt"}),t.jsx("p",{children:"As you finish identifying the misplaced items, the Elves come to you with another issue."}),t.jsxs("p",{children:["For safety, the Elves are divided into groups of three. Every Elf carries a badge that identifies their group. For efficiency, within each group of three Elves, the badge is the ",t.jsx("em",{children:"only item type carried by all three Elves"}),". That is, if a group's badge is item type ",t.jsx("code",{children:"B"}),", then all three Elves will have item type"," ",t.jsx("code",{children:"B"})," somewhere in their rucksack, and at most two of the Elves will be carrying any other item type."]}),t.jsx("p",{children:"The problem is that someone forgot to put this year's updated authenticity sticker on the badges. All of the badges need to be pulled out of the rucksacks so the new authenticity stickers can be attached."}),t.jsxs("p",{children:["Additionally, nobody wrote down which item type corresponds to each group's badges. The only way to tell which item type is the right one is by finding the one item type that is ",t.jsx("em",{children:"common between all three Elves"})," in each group."]}),t.jsx("p",{children:"Every set of three lines in your list corresponds to a single group, but each group can have a different badge item type. So, in the above example, the first group's rucksacks are the first three lines:"}),t.jsx(T,{content:`vJrwpWtwJgWrhcsFMMfFFhFp
jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL
