...
def test_runner(filename: str, seeds: list[int], total: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == total
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"52,510,809"})]}),e.jsx(n,{}),e.jsx(t,{hash:"recap",children:"Recap"}),e.jsxs(i,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"5"}),e.jsx("td",{children:"00:35:47"}),e.jsx("td",{children:"4,028"}),e.jsx("td",{children:"02:31:26"}),e.jsx("td",{children:"5,566"})]})})]}),e.jsx("p",{children:"This was very hard to reason about and work through 😖."}),e.jsx("p",{children:"I'm just happy I made it through this problem without needing to go super late into the night."})]})};export{j as component};
