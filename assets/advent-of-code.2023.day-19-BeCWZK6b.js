...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"121,158,073,425,385"})]}),e.jsx(t,{}),e.jsx(s,{hash:"recap",children:"Recap"}),e.jsxs(n,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"19"}),e.jsx("td",{children:"00:31:38"}),e.jsx("td",{children:"1,809"}),e.jsx("td",{children:"01:21:18"}),e.jsx("td",{children:"1,528"})]})})]}),e.jsx("p",{children:"I hate range problems 😖"})]})};export{m as component};
