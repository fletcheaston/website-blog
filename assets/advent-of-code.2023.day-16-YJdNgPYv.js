import{j as e,a_ as r}from"./main-DdHQErvU.js";import{P as i,a as t}from"./code-block-aPXLCB2L.js";import{B as a}from"./layout-DvqNAMRu.js";import{H as n}from"./header-D86GcD9X.js";import{T as d}from"./table-Dgl1a-zm.js";import{S as o}from"./separator-LnusGYe2.js";import"./button-CFX2dUjs.js";const f=function(){return e.jsxs(e.Fragment,{children:[e.jsx(a,{to:r.fullPath}),e.jsx(n,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsxs("p",{children:["With the beam of light completely focused ",e.jsx("strong",{children:"somewhere"}),", the reindeer leads you deeper still into the Lava Production Facility. At some point, you realize that the steel facility walls have been replaced with cave, and the doorways are just cave, and the floor is cave, and you're pretty sure this is actually just a giant cave."]}),e.jsx("p",{children:"Finally, as you approach what must be the heart of the mountain, you see a bright light in a cavern up ahead. There, you discover that the beam of light you so carefully focused is emerging from the cavern wall closest to the facility and pouring all of its energy into a contraption on the opposite side."}),e.jsxs("p",{children:["Upon closer inspection, the contraption appears to be a flat, two-dimensional square grid containing ",e.jsx("strong",{children:"empty space"})," (",e.jsx("code",{children:"."}),"),"," ",e.jsx("strong",{children:"mirrors"})," (",e.jsx("code",{children:"/"})," and ",e.jsx("code",{children:"\\"}),"), and"," ",e.jsx("strong",{children:"splitters"})," (",e.jsx("code",{children:"|"})," and ",e.jsx("code",{children:"-"}),")."]}),e.jsxs("p",{children:["The contraption is aligned so that most of the beam bounces around the grid, but each tile on the grid converts some of the beam's light into ",e.jsx("strong",{children:"heat"})," ","to melt the rock in the cavern."]}),e.jsx("p",{children:"You note the layout of the contraption (your puzzle input). For example:"}),e.jsx(i,{content:`.|...\\....
|.-.\\.....
.....|-...
........|.
..........
