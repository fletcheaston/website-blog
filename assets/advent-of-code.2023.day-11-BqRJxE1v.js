import{j as e,aD as i}from"./index-CwtsGJj3.js";import{P as t,a as s}from"./code-block-CHCiU50r.js";import{B as l}from"./layout-Cohubq0h.js";import{H as a}from"./header-B7Z-ZQsD.js";import{T as r}from"./table-C6tbeujV.js";import{S as n}from"./separator-B6g9dnjl.js";import"./button-D317vur7.js";import"./routeInfo-Bh0-5ykf.js";const g=function(){return e.jsxs(e.Fragment,{children:[e.jsx(l,{to:i.fullPath}),e.jsx(a,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsx("p",{children:'You continue following signs for "Hot Springs" and eventually come across an observatory. The Elf within turns out to be a researcher studying cosmic expansion using the giant telescope here.'}),e.jsx("p",{children:"He doesn't know anything about the missing machine parts; he's only visiting for this research project. However, he confirms that the hot springs are the next-closest area likely to have people; he'll even take you straight there once he's done with today's observation analysis."}),e.jsx("p",{children:"Maybe you can help him with the analysis to speed things up?"}),e.jsxs("p",{children:["The researcher has collected a bunch of data and compiled the data into a single giant ",e.jsx("strong",{children:"image"})," (your puzzle input). The image includes"," ",e.jsx("strong",{children:"empty space"})," (",e.jsx("code",{children:"."}),") and ",e.jsx("strong",{children:"galaxies"})," (",e.jsx("code",{children:"#"}),"). For example:"]}),e.jsx(t,{content:`...#......
.......#..
#.........
..........
......#...
...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"648,458,253,817"})]}),e.jsx(n,{}),e.jsx(a,{hash:"recap",children:"Recap"}),e.jsxs(r,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"11"}),e.jsx("td",{children:"00:30:42"}),e.jsx("td",{children:"3,942"}),e.jsx("td",{children:"02:24:34"}),e.jsx("td",{children:"9,580"})]})})]}),e.jsx("p",{children:"Part 1 was fairly straightforward. I got stuck on Part 2 for so long because of an off-by-one error when I double-counted rows/columns, which didn't occur in Part 1."}),e.jsx("p",{children:"After solving Part 2, I updated the Part 1 code to match."})]})};export{g as component};
