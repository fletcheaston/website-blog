...
def test_runner(filename: str, output: int) -> None:
    with open(Path(__file__).with_name(filename)) as file:
        ...
        assert result == output
`}),e.jsxs("p",{children:["Answer: ",e.jsx("code",{children:"864"})]}),e.jsx(r,{}),e.jsx(s,{hash:"recap",children:"Recap"}),e.jsxs(a,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Day"}),e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"9"}),e.jsx("td",{children:"00:20:30"}),e.jsx("td",{children:"4,002"}),e.jsx("td",{children:"00:31:35"}),e.jsx("td",{children:"4,754"})]})})]}),e.jsx("p",{children:"This was a pretty fun one, not all that challenging and very satisfying to do!"}),e.jsxs("p",{children:["The most annoying part was that I got the arguments for ",e.jsx("code",{children:"list.insert"})," ","backwards. I kept trying to insert ",e.jsx("code",{children:"0"})," into lists at the ",e.jsx("code",{children:"nth"})," ","position instead of ",e.jsx("code",{children:"n"})," at the start of each list 🙃. Only wasted ~5 minutes or so being very confused ¯\\_(ツ)_/¯."]}),e.jsxs("p",{children:["The end result for the ",e.jsx("code",{children:"History"})," data model is pretty satisfying, the only moderately complex part is array indexing in the"," ",e.jsxs("code",{children:["fill_in_","{","forwards | backwards","}"]})," ","methods. And even that isn't too bad."]})]})};export{y as component};
