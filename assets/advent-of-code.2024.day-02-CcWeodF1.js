import{a as o,j as e,aM as k}from"./index-DUkI3zN4.js";import{z as c,I as y}from"./view-input-RoXKJ-rz.js";import{s as b}from"./utils-D-kyB9IB.js";import{B as w}from"./button-CPeYYkJc.js";import{P as S,T as u}from"./code-block-CUzIZK_S.js";import{B as T}from"./layout-EI8iacjT.js";import{H as h}from"./header-CsaC9489.js";import{T as D}from"./table-DbvmoelV.js";import{S as g}from"./separator-BWcHTm7a.js";const x=`67 69 71 72 75 78 76
4 6 7 9 11 12 12
...
57 55 52 51 49
15 17 20 23 25`,I=c.array(c.string().transform(r=>r.split(" ")).pipe(c.array(c.coerce.number()))),v=I.parse(x.split(`
`));function V(r){let s;for(const a of r){if(s!==void 0&&s>a)return!1;s=a}return!0}function z(r){let s;for(const a of r){if(s!==void 0&&s<a)return!1;s=a}return!0}function R(r,s,a){let n;for(const i of r){if(n!==void 0){const t=Math.abs(n-i);if(t<s||t>a)return!1}n=i}return!0}function B(){const[r,s]=o.useState("unstarted"),[a,n]=o.useState(0),[i,t]=o.useState(0),j=o.useCallback(async()=>{s("in-progress"),t(0),n(0);for await(const d of v)n(l=>l+1),(V(d)||z(d))&&R(d,1,3)&&t(l=>l+1),await b(1);s("complete")},[s,t,n]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mt-4 flex gap-x-4",children:[e.jsx("div",{children:e.jsx(y,{input:x})}),e.jsx("div",{children:e.jsx(w,{size:"lg",onClick:j,disabled:r==="in-progress",children:"Process Input"})})]}),e.jsxs("div",{className:"mt-4 tabular-nums",children:[e.jsxs("div",{children:["Progress: ",a," / ",v.length]}),e.jsxs("div",{children:["Total: ",i]})]})]})}const C=c.array(c.string().transform(r=>r.split(" ")).pipe(c.array(c.coerce.number()))),f=C.parse(x.split(`
`));function H(r){let s;for(const a of r){if(s!==void 0&&s>a)return!1;s=a}return!0}function N(r){let s;for(const a of r){if(s!==void 0&&s<a)return!1;s=a}return!0}function U(r,s,a){let n;for(const i of r){if(n!==void 0){const t=Math.abs(n-i);if(t<s||t>a)return!1}n=i}return!0}function A(){const[r,s]=o.useState("unstarted"),[a,n]=o.useState(0),[i,t]=o.useState(0),j=o.useCallback(async()=>{s("in-progress"),t(0),n(0);for await(const d of f){n(l=>l+1);for(let l=-1;l<f.length;l++){const p=d.filter((m,P)=>P!==l);(H(p)||N(p))&&U(p,1,3)&&(t(m=>m+1),l=f.length)}await b(1)}s("complete")},[s,t,n]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mt-4 flex gap-x-4",children:[e.jsx("div",{children:e.jsx(y,{input:x})}),e.jsx("div",{children:e.jsx(w,{size:"lg",onClick:j,disabled:r==="in-progress",children:"Process Input"})})]}),e.jsxs("div",{className:"mt-4 tabular-nums",children:[e.jsxs("div",{children:["Progress: ",a," / ",f.length]}),e.jsxs("div",{children:["Total: ",i]})]})]})}const J=function(){return e.jsxs(e.Fragment,{children:[e.jsx(T,{to:k.fullPath}),e.jsx(h,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsx("p",{children:"Fortunately, the first location The Historians want to search isn't a long walk from the Chief Historian's office."}),e.jsxs("p",{children:["While the"," ",e.jsx("a",{href:"https://adventofcode.com/2015/day/19",target:"_blank",children:"Red-Nosed Reindeer nuclear fusion/fission plant"})," ","appears to contain no sign of the Chief Historian, the engineers there run up to you as soon as they see you. Apparently, they ",e.jsx("em",{children:"still"})," talk about the time Rudolph was saved through molecular synthesis from a single electron."]}),e.jsx("p",{children:"They're quick to add that - since you're already here - they'd really appreciate your help analyzing some unusual data from the Red-Nosed reactor. You turn to check if The Historians are waiting for you, but they seem to have already divided into groups that are currently searching every corner of the facility. You offer to help with the unusual data."}),e.jsxs("p",{children:["The unusual data (your puzzle input) consists of many ",e.jsx("em",{children:"reports"}),", one report per line. Each report is a list of numbers called ",e.jsx("em",{children:"levels"})," that are separated by spaces. For example:"]}),e.jsx(S,{content:`7 6 4 2 1
1 2 7 8 9
9 7 6 2 1
1 3 2 4 5
8 6 4 4 1
1 3 6 7 9`}),e.jsx("p",{children:"This example data contains six reports each containing five levels."}),e.jsxs("p",{children:["The engineers are trying to figure out which reports are ",e.jsx("em",{children:"safe"}),". The Red-Nosed reactor safety systems can only tolerate levels that are either gradually increasing or gradually decreasing. So, a report only counts as safe if both of the following are true:"]}),e.jsxs("ul",{children:[e.jsxs("li",{children:["The levels are either ",e.jsx("em",{children:"all increasing"})," or ",e.jsx("em",{children:"all decreasing"}),"."]}),e.jsxs("li",{children:["Any two adjacent levels differ by ",e.jsx("em",{children:"at least one"})," and"," ",e.jsx("em",{children:"at most three"}),"."]})]}),e.jsx("p",{children:"In the example above, the reports can be found safe or unsafe by checking those rules:"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"7 6 4 2 1"}),": ",e.jsx("em",{children:"Safe"})," because the levels are all decreasing by 1 or 2."]}),e.jsxs("li",{children:[e.jsx("code",{children:"1 2 7 8 9"}),": ",e.jsx("em",{children:"Unsafe"})," because ",e.jsx("code",{children:"2 7"})," is an increase of 5."]}),e.jsxs("li",{children:[e.jsx("code",{children:"9 7 6 2 1"}),": ",e.jsx("em",{children:"Unsafe"})," because ",e.jsx("code",{children:"6 2"})," is a decrease of 4."]}),e.jsxs("li",{children:[e.jsx("code",{children:"1 3 2 4 5"}),": ",e.jsx("em",{children:"Unsafe"})," because ",e.jsx("code",{children:"1 3"})," is increasing but ",e.jsx("code",{children:"3 2"})," is decreasing."]}),e.jsxs("li",{children:[e.jsx("code",{children:"8 6 4 4 1"}),": ",e.jsx("em",{children:"Unsafe"})," because ",e.jsx("code",{children:"4 4"})," is neither an increase or a decrease."]}),e.jsxs("li",{children:[e.jsx("code",{children:"1 3 6 7 9"}),": ",e.jsx("em",{children:"Safe"})," because the levels are all increasing by 1, 2, or 3."]})]}),e.jsxs("p",{children:["So, in this example,"," ",e.jsx("code",{children:e.jsx("em",{children:"2"})})," ","reports are ",e.jsx("em",{children:"safe"}),"."]}),e.jsxs("p",{children:["Analyze the unusual data from the engineers. ",e.jsx("em",{children:"How many reports are safe?"})]}),e.jsx(h,{hash:"part-1-solution",children:"Part 1 – Solution"}),e.jsx(B,{}),e.jsxs("p",{children:[e.jsx("code",{children:"zod"})," did the heavy lifting for initial data parsing, of course:"]}),e.jsx(u,{content:`import { z } from "zod";
...
}`}),e.jsx(g,{}),e.jsx(h,{hash:"recap",children:"Recap"}),e.jsxs(D,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"00:19:10"}),e.jsx("td",{children:"6,592"}),e.jsx("td",{children:"00:23:18"}),e.jsx("td",{children:"3,459"})]})})]}),e.jsxs("p",{children:["This was fairly easy, I just spent a lot of time on the Part 1 making sure my helper functions were correct. The ",e.jsx("code",{children:"allIncreasing"})," and"," ",e.jsx("code",{children:"allDecreasing"})," functions only took a minute or so each, but"," ",e.jsx("code",{children:"allDifferBy"})," took a bit longer ¯\\_(ツ)_/¯."]})]})};export{J as component};
