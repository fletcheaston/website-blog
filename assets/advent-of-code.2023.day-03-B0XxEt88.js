import{j as e,b9 as s}from"./main-CV-jdQ_C.js";import{P as r,a as t}from"./code-block-BIvcJb77.js";import{B as d}from"./layout-BHv86BKp.js";import{H as n}from"./header-BtPm5KK-.js";import{T as i}from"./table-Dn-AaJC3.js";import{S as c}from"./separator-eCvJb-7k.js";import"./button-DiQvsG2T.js";const p=function(){return e.jsxs(e.Fragment,{children:[e.jsx(d,{to:s.fullPath}),e.jsx(n,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsxs("p",{children:["You and the Elf eventually reach a gondola lift station; he says the gondola lift will take you up to the ",e.jsx("strong",{children:"water source"}),", but this is as far as he can bring you. You go inside."]}),e.jsx("p",{children:"It doesn't take long to find the gondolas, but there seems to be a problem: they're not moving."}),e.jsx("p",{children:'"Aaah!"'}),e.jsx("p",{children:`You turn around to see a slightly-greasy Elf with a wrench and a look of surprise. "Sorry, I wasn't expecting anyone! The gondola lift isn't working right now; it'll still be a while before I can fix it." You offer to help.`}),e.jsxs("p",{children:["The engineer explains that an engine part seems to be missing from the engine, but nobody can figure out which one. If you can"," ",e.jsx("strong",{children:"add up all the part numbers"})," in the engine schematic, it should be easy to work out which part is missing."]}),e.jsxs("p",{children:["The engine schematic (your puzzle input) consists of a visual representation of the engine. There are lots of numbers and symbols you don't really understand, but apparently ",e.jsx("strong",{children:"any number adjacent to a symbol"}),', even diagonally, is a "part number" and should be included in your sum. (Periods (.) do not count as a symbol.)']}),e.jsx("p",{children:"Here is an example engine schematic:"}),e.jsx(r,{content:`467..114..
...*......
..35..633.
......#...
617*......
