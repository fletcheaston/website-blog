import{j as e}from"./index-asdfw01p.js";import{P as i,a as t}from"./code-block-DGk06EOt.js";import{B as r}from"./layout-Bbw6xlVW.js";import{H as n}from"./header-bLivdw4r.js";import{T as a}from"./table-CewKNS46.js";import{S as o}from"./separator-COdazgSt.js";import"./button-DxUZDvDh.js";import"./routeInfo-DwfsGK-b.js";const f=function(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{}),e.jsx(n,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsxs("p",{children:["With the beam of light completely focused ",e.jsx("strong",{children:"somewhere"}),", the reindeer leads you deeper still into the Lava Production Facility. At some point, you realize that the steel facility walls have been replaced with cave, and the doorways are just cave, and the floor is cave, and you're pretty sure this is actually just a giant cave."]}),e.jsx("p",{children:"Finally, as you approach what must be the heart of the mountain, you see a bright light in a cavern up ahead. There, you discover that the beam of light you so carefully focused is emerging from the cavern wall closest to the facility and pouring all of its energy into a contraption on the opposite side."}),e.jsxs("p",{children:["Upon closer inspection, the contraption appears to be a flat, two-dimensional square grid containing ",e.jsx("strong",{children:"empty space"})," (",e.jsx("code",{children:"."}),"),"," ",e.jsx("strong",{children:"mirrors"})," (",e.jsx("code",{children:"/"})," and ",e.jsx("code",{children:"\\"}),"), and"," ",e.jsx("strong",{children:"splitters"})," (",e.jsx("code",{children:"|"})," and ",e.jsx("code",{children:"-"}),")."]}),e.jsxs("p",{children:["The contraption is aligned so that most of the beam bounces around the grid, but each tile on the grid converts some of the beam's light into ",e.jsx("strong",{children:"heat"})," ","to melt the rock in the cavern."]}),e.jsx("p",{children:"You note the layout of the contraption (your puzzle input). For example:"}),e.jsx(i,{content:`.|...\\....
|.-.\\.....
.....|-...
........|.
..........
