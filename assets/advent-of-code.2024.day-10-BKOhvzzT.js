var k=Object.defineProperty;var v=(i,t,s)=>t in i?k(i,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):i[t]=s;var g=(i,t,s)=>v(i,typeof t!="symbol"?t+"":t,s);import{r as h,j as e}from"./index-asdfw01p.js";import{s as b}from"./utils-D-kyB9IB.js";import{z as x,I as w}from"./view-input-CL2vAZfB.js";import{B as P}from"./button-DxUZDvDh.js";import{P as n,T as y}from"./code-block-DGk06EOt.js";import{B as S}from"./layout-Bbw6xlVW.js";import{H as d}from"./header-bLivdw4r.js";import{T}from"./table-CewKNS46.js";import{C as $}from"./callout-CcPio8dw.js";import{S as f}from"./separator-COdazgSt.js";import"./routeInfo-DwfsGK-b.js";const p=`012589824304345454345653403898787654310365890
...
210189876540107601095432398874322103210187878`,I=x.array(x.string().transform(i=>i.split(""))),A=I.parse(p.split(`
`));let _=class{constructor(t){g(this,"matrix");this.matrix=JSON.parse(JSON.stringify(t))}get trailheads(){const t=[];return this.matrix.forEach((s,a)=>{s.forEach((r,o)=>{r==="0"&&t.push({y:a,x:o})})}),t}at(t){var s;return(s=this.matrix[t.y])==null?void 0:s[t.x]}getPaths(t,s){if(s===9)return[`${t.y},${t.x}`];const a=[];return this.at({y:t.y-1,x:t.x})===`${s+1}`&&a.push(...this.getPaths({y:t.y-1,x:t.x},s+1)),this.at({y:t.y,x:t.x+1})===`${s+1}`&&a.push(...this.getPaths({y:t.y,x:t.x+1},s+1)),this.at({y:t.y+1,x:t.x})===`${s+1}`&&a.push(...this.getPaths({y:t.y+1,x:t.x},s+1)),this.at({y:t.y,x:t.x-1})===`${s+1}`&&a.push(...this.getPaths({y:t.y,x:t.x-1},s+1)),a}toJSON(){return this.matrix.map(t=>t.join(""))}};function C(){const[i,t]=h.useState("unstarted"),[s,a]=h.useState(0),r=h.useRef(),[o,l]=h.useState(0),m=h.useCallback(async()=>{t("in-progress"),a(0),l(0),r.current=new _(A);for await(const u of r.current.trailheads){a(c=>c+1);const j=new Set(r.current.getPaths(u,0));l(c=>c+j.size),await b(1)}t("complete")},[t,l,a]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mt-4 flex gap-x-4",children:[e.jsx("div",{children:e.jsx(w,{input:p})}),e.jsx("div",{children:e.jsx(P,{size:"lg",onClick:m,disabled:i==="in-progress",children:"Process Input"})})]}),e.jsxs("div",{className:"mt-4 tabular-nums",children:[e.jsxs("div",{children:["Iterations: ",s]}),e.jsxs("div",{children:["Paths: ",o]})]})]})}const N=x.array(x.string().transform(i=>i.split(""))),J=N.parse(p.split(`
`));class q{constructor(t){g(this,"matrix");this.matrix=JSON.parse(JSON.stringify(t))}get trailheads(){const t=[];return this.matrix.forEach((s,a)=>{s.forEach((r,o)=>{r==="0"&&t.push({y:a,x:o})})}),t}at(t){var s;return(s=this.matrix[t.y])==null?void 0:s[t.x]}getPaths(t,s){if(s===9)return[`${t.y},${t.x}`];const a=[];return this.at({y:t.y-1,x:t.x})===`${s+1}`&&a.push(...this.getPaths({y:t.y-1,x:t.x},s+1)),this.at({y:t.y,x:t.x+1})===`${s+1}`&&a.push(...this.getPaths({y:t.y,x:t.x+1},s+1)),this.at({y:t.y+1,x:t.x})===`${s+1}`&&a.push(...this.getPaths({y:t.y+1,x:t.x},s+1)),this.at({y:t.y,x:t.x-1})===`${s+1}`&&a.push(...this.getPaths({y:t.y,x:t.x-1},s+1)),a}toJSON(){return this.matrix.map(t=>t.join(""))}}function z(){const[i,t]=h.useState("unstarted"),[s,a]=h.useState(0),r=h.useRef(),[o,l]=h.useState(0),m=h.useCallback(async()=>{t("in-progress"),a(0),l(0),r.current=new q(J);for await(const u of r.current.trailheads){a(c=>c+1);const j=r.current.getPaths(u,0);l(c=>c+j.length),await b(1)}t("complete")},[t,l,a]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mt-4 flex gap-x-4",children:[e.jsx("div",{children:e.jsx(w,{input:p})}),e.jsx("div",{children:e.jsx(P,{size:"lg",onClick:m,disabled:i==="in-progress",children:"Process Input"})})]}),e.jsxs("div",{className:"mt-4 tabular-nums",children:[e.jsxs("div",{children:["Iterations: ",s]}),e.jsxs("div",{children:["Paths: ",o]})]})]})}const K=function(){return e.jsxs(e.Fragment,{children:[e.jsx(S,{}),e.jsx(d,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsxs("p",{children:["You all arrive at a"," ",e.jsx("a",{href:"https://adventofcode.com/2023/day/15",target:"_blank",children:"Lava Production Facility"})," ","on a floating island in the sky. As the others begin to search the massive industrial complex, you feel a small nose boop your leg and look down to discover a"," ",e.jsx("span",{title:"i knew you would come back",children:"reindeer"})," wearing a hard hat."]}),e.jsxs("p",{children:[`The reindeer is holding a book titled "Lava Island Hiking Guide". However, when you open the book, you discover that most of it seems to have been scorched by lava! As you're about to ask how you can help, the reindeer brings you a blank`," ",e.jsx("a",{href:"https://en.wikipedia.org/wiki/Topographic_map",target:"_blank",children:"topographic map"})," ","of the surrounding area (your puzzle input) and looks up at you excitedly."]}),e.jsx("p",{children:"Perhaps you can help fill in the missing hiking trails?"}),e.jsxs("p",{children:["The topographic map indicates the ",e.jsx("em",{children:"height"})," at each position using a scale from ",e.jsx("code",{children:"0"})," (lowest) to ",e.jsx("code",{children:"9"})," (highest). For example:"]}),e.jsx(n,{content:`0123
1234
8765
...
32019012
01329801
10456732`}),e.jsxs("p",{children:["Considering its trailheads in reading order, they have ratings of ",e.jsx("code",{children:"20"}),","," ",e.jsx("code",{children:"24"}),", ",e.jsx("code",{children:"10"}),", ",e.jsx("code",{children:"4"}),", ",e.jsx("code",{children:"1"}),", ",e.jsx("code",{children:"4"}),","," ",e.jsx("code",{children:"5"}),", ",e.jsx("code",{children:"8"}),", and ",e.jsx("code",{children:"5"}),". The sum of all trailhead ratings in this larger example topographic map is"," ",e.jsx("code",{children:e.jsx("em",{children:"81"})}),"."]}),e.jsxs("p",{children:["You're not sure how, but the reindeer seems to have crafted some tiny flags out of toothpicks and bits of paper and is using them to mark trailheads on your topographic map. ",e.jsx("em",{children:"What is the sum of the ratings of all trailheads?"})]}),e.jsx(d,{hash:"part-2-solution",children:"Part 2 – Solution"}),e.jsx(z,{}),e.jsxs("p",{children:["This uses the ",e.jsx("em",{children:"exact same code"})," as Part 1, but I don't de-duplicate trailends."]}),e.jsx(f,{}),e.jsx(d,{hash:"recap",children:"Recap"}),e.jsxs(T,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Part 1 Time"}),e.jsx("th",{children:"Part 1 Rank"}),e.jsx("th",{children:"Part 2 Time"}),e.jsx("th",{children:"Part 2 Rank"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"00:22:14"}),e.jsx("td",{children:"3,459"}),e.jsx("td",{children:"00:23:56"}),e.jsx("td",{children:"2,795"})]})})]}),e.jsxs("p",{children:["This was fairly easy, especially for a Day 10 problem. I'm super proud of my Part 2 solution, which ",e.jsx("em",{children:"only required me to change two lines of code"})," from my Part 1 solution. All of the time spent on Part 2 was double-checking the given examples to make sure I didn't miss anything."]}),e.jsx("h3",{children:"Part 1"}),e.jsx(y,{content:`const trailends = new Set(map.getPaths(trailhead, 0));

runningTotal += trailends.size;`}),e.jsx("h3",{children:"Part 2"}),e.jsx(y,{content:`const trailends = map.getPaths(trailhead, 0);

runningTotal += trailends.length;`})]})};export{K as component};
