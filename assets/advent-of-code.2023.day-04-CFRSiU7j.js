import{j as e,b2 as t}from"./index-DUkI3zN4.js";import{P as s,a as r}from"./code-block-CUzIZK_S.js";import{B as o}from"./layout-EI8iacjT.js";import{H as n}from"./header-CsaC9489.js";import{T as a}from"./table-DbvmoelV.js";import{S as i}from"./separator-BWcHTm7a.js";import"./button-CPeYYkJc.js";const f=function(){return e.jsxs(e.Fragment,{children:[e.jsx(o,{to:t.fullPath}),e.jsx(n,{hash:"part-1-prompt",children:"Part 1 – Prompt"}),e.jsx("p",{children:"The gondola takes you up. Strangely, though, the ground doesn't seem to be coming with you; you're not climbing a mountain. As the circle of Snow Island recedes below you, an entire new landmass suddenly appears above you! The gondola carries you to the surface of the new island and lurches into the station."}),e.jsxs("p",{children:["As you exit the gondola, the first thing you notice is that the air here is much"," ",e.jsx("strong",{children:"warmer"})," than it was on Snow Island. It's also quite"," ",e.jsx("strong",{children:"humid"}),". Is this where the water source is?"]}),e.jsx("p",{children:"The next thing you notice is an Elf sitting on the floor across the station in what seems to be a pile of colorful square cards."}),e.jsx("p",{children:'"Oh! Hello!" The Elf excitedly runs over to you. "How may I be of service?" You ask about water sources.'}),e.jsxs("p",{children:[`"I'm not sure; I just operate the gondola lift. That does sound like something we'd have, though - this is `,e.jsx("strong",{children:"Island Island"}),", after all! I bet the"," ",e.jsx("strong",{children:"gardener"})," would know. He's on a different island, though - er, the small kind surrounded by water, not the floating kind. We really need to come up with a better naming scheme. Tell you what: if you can help me with something quick, I'll let you ",e.jsx("strong",{children:"borrow my boat"}),` and you can go visit the gardener. I got all these scratchcards as a gift, but I can't figure out what I've won."`]}),e.jsxs("p",{children:["The Elf leads you over to the pile of colorful cards. There, you discover dozens of scratchcards, all with their opaque covering already scratched off. Picking one up, it looks like each card has two lists of numbers separated by a vertical bar (|): a list of ",e.jsx("strong",{children:"winning numbers"})," and then a list of"," ",e.jsx("strong",{children:"numbers you have"}),". You organize the information into a table (your puzzle input)."]}),e.jsxs("p",{children:["As far as the Elf has been able to figure out, you have to figure out which of the"," ",e.jsx("strong",{children:"numbers you have"})," appear in the list of"," ",e.jsx("strong",{children:"winning numbers"}),". The first match makes the card worth one point and each match after the first ",e.jsx("strong",{children:"doubles"})," the point value of that card."]}),e.jsx("p",{children:"For example:"}),e.jsx(s,{content:`Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53
